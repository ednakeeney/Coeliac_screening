...
tests_of_interest <- c("IgAEMA", "IgAEMA plus HLA")
...
utility_parameters <- data.frame(input_parameters$utility_GFD, input_parameters$utility_undiagnosedCD,  
...
cost_parameters <- data.frame( input_parameters$cost_CDGFD, input_parameters$cost_osteoporosis, input_parameters$cost_undiagnosedCD, 
                               ...
                               input_parameters$cost_NHL,input_parameters$cost_diagnosis,
