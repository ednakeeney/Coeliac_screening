generate_transition_matrices <- function(input_parameters) {
  ...
  for(i_age_category in c(0:4)) {
    ...
    transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed CD no complications", "Undiagnosed CD subfertility"] <- subfertility_probability_noGFD_all[, starting_age_column + i_age_category]
    transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed CD no complications", "Undiagnosed CD osteoporosis"] <- osteoporosis_probability_noGFD_all[, starting_age_column + i_age_category]
    transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed CD subfertility", "Undiagnosed CD osteoporosis"] <- osteoporosis_probability_noGFD_all[, starting_age_column + i_age_category]
    transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed CD no complications", "CD GFD subfertility"] <- adherence * probability_late_diagnosis * subfertility_probability_noGFD_all[, starting_age_column + i_age_category]
    transition_matrices[, (c(1:10) + i_age_category * 10), "Undiagnosed CD no complications", "CD GFD osteoporosis"] <- adherence * probability_late_diagnosis * osteoporosis_probability_noGFD_all[, starting_age_column + i_age_category]
  ...
  transition_matrices[, , "Undiagnosed CD no complications", "CD GFD NHL"] <- adherence * probability_late_diagnosis * NHL_probability_GFD
